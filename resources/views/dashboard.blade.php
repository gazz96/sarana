    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="font-semibold">{{ getChartTitle($role, 'status') }}</h5>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="font-semibold">{{ getChartTitle($role, 'trend') }}</h5>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="font-semibold">Problems by Location</h5>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="font-semibold">Top Damaged Goods</h5>
            </div>
            <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="badge badge-primary">{{ count($statistics['recent_activities']) }} Items</span>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><strong>{{ $activity['code'] ?? 'N/A' }}</strong></td>
                                    ...
                                    <td><small class="text-muted">{{ $activity['updated_at'] ?? '' }}</small></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="card-body">
                    <div class="flex flex-col gap-3">
                        ...
                        <a href="{{ $url }}" class="action-card">
                            ...
                            <span class="font-medium">{{ ucfirst(str_replace('_', ' ', $action)) }}</span>
